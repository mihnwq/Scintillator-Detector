...
void EventAction::BeginOfEventAction(const G4Event* event)
{
  ...
  fTrackLGap = 0.;
  /*fPhot1Count = 0;
  fPhot2Count = 0; incercarea veche in care am presupus folosirea unui sensitive detector
  fScintHCID = -1;*/
...
void EventAction::EndOfEventAction(const G4Event* event)
{
  ...
  analysisManager->FillNtupleIColumn(4, fPhotonCount);
  analysisManager->FillNtupleDColumn(5, fPhotonEnergy);
  analysisManager->AddNtupleRow();
